...
export const Ovr = () => {
  ...
  const slideRightStyle_receiveButton = {
    ...
    // render() {
    //     if (this.state.function === "up") {
    //         return (
    //             <>
    //                 <TopBar />
    //                 <Up
    //                     switch_function={this.to_down}
    //                 />
    //             </>
    //         )
    //     }
    //     if (this.state.function === "down") {
    //         return (
    //             <>
    //                 <TopBar />
    //                 <Down
    //                     switch_function={this.to_up}
    //                 />
    //             </>
    //         )
    //     }
    ...
    //                         </div>
    //                         <div className="send_receive_button_container">
    //                             <button className="send_button" onClick={this.to_up}>SEND</button>
    //                             <button className="receive_button" onClick={this.to_down}>RECEIVE</button>
    //                         </div>
                            // <motion.div
